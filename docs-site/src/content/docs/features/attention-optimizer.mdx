...
The first-and-last preference is a property of how large models read long context. The [line-200 MEMORY.md cutoff](/features/memory-health/) is the strictest application of the same bias: position decides whether content lands at all, and where it lands decides how much weight it carries.
</Aside>
