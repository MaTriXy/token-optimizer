...
| `additionalContext` on preToolUse | Broken upstream in Copilot CLI | Read interception, deferred |
| `additionalContext` on userPromptSubmitted | Regressed upstream in Copilot CLI | Per-prompt quality steering, deferred |
