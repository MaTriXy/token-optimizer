...
For install commands, doctor commands, hook profiles, and platform-specific caveats, see the platform pages: [Claude Code](/platforms/claude-code/), [Codex](/platforms/codex/), [OpenCode](/platforms/opencode/), [OpenClaw](/platforms/openclaw/), [Hermes](/platforms/hermes/), [Copilot](/platforms/copilot/), and [Cowork](/platforms/cowork/).
