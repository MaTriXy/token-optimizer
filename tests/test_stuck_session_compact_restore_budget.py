...
Root cause of the ~36s first-prompt stall when multiple concurrent sessions share
one project dir: `compact-restore --new-session-only` was the ONLY synchronous
